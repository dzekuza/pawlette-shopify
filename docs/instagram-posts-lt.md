...
| Day | Post | Pillar |
|-----|------|--------|
| Day 1 | `2nd.jpg` | Brand intro |
| Day 2 | `1st.jpg` | Lifestyle |
| Day 3 | `5.jpg` | Product range / engagement |
| Day 4 | `4.jpg` | Product showcase |
| Day 5 | `9.jpg` | Dog portrait / comment bait |
| Day 6 | `3.jpg` | Emotional / gift idea |
| Day 7 | `6.jpg` | Product showcase |
| Day 8 | `7.jpg` | Cozy lifestyle |
| Day 9 | `8.jpg` | Active lifestyle / summer |
| Story | `Instagram story - 1.jpg` | Run Day 1 + repost Day 5 |

**Core LT hashtags to always include:** `#šunys #šuniukas #šunyslietuva #lietuva #šunųmama #augintinis`

---

## POST 1 — `1st.jpg`
*Woman + Golden Retriever "Bear" on park bench*  
**Pillar: Lifestyle / emotional bond**

### Caption
Kiekvienas šuo yra ypatingas. Kodėl jo antakalis turėtų būti kaip visiems? 🐾

Personalizuoti antkakliai su silikoninėmis raidėmis — sukurti specialiai tavo augintiniui. Pasirink spalvą, surink vardą, ir leisk jam blizgėti.
...
## POST 3 — `3.jpg`
*Older woman + Cocker Spaniel "Poppy" in flower garden*  
**Pillar: Emotional / gift idea**

### Caption
Meilė neturi amžiaus — nei šuns, nei šeimininkės 🌸

Poppy dėvi savo vardą su pasididžiavimu. O tavo augintinis?

Sukurk unikalų antakalį su savo šuns vardu — priešužsakymai jau priimami.
...
## POST 4 — `4.jpg`
*Product shot: Navy blue collar with pink "Rocky" letter charms*  
**Pillar: Product showcase / style**

### Caption
Tamsiai mėlyna + rožinės raidės = meilė iš pirmo žvilgsnio 💙🩷

Rocky žino, kaip atrodyti stilingai. Tavo šuo — irgi gali.

Pasirink spalvą. Surašyk vardą. Ir tegul visi žino, kas jis toks.
...
## POST 5 — `5.jpg`
*Flat lay: 6 pastel collars — Teddy, Coco, Bear, Duke, Rosie*  
**Pillar: Engagement / product range**

### Caption
Teddy. Coco. Bear. Duke. Rosie. 🌈

Kiekvienas vardas — savita spalva. Kiekvienas šuo — sava asmenybė.

Mūsų silikoniniai antkakliai atsparūs, švelnūs ir nepaprastai gražūs.
...
## POST 6 — `6.jpg`
*Product shot: Pink collar with purple "Daisy" letter charms*  
**Pillar: Product showcase / aesthetic**

### Caption
Rožinė + levandų raidės = grynoji Daisy energija 🌸💜

Antakalis ne tik apsaugo — jis pasakoja istoriją. Tavo šuns vardas, tavo spalvos, tavo stilius.
...
## POST 7 — `7.jpg`
*Couple on couch with curly dog "Nola"*  
**Pillar: Lifestyle / family / cozy**

### Caption
Nola jau žino — ji yra šeimos centras 🤎
...
## POST 8 — `8.jpg`
*Woman running on beach with Border Collie "Scout"*  
**Pillar: Active lifestyle / summer**

### Caption
Paplūdimys. Saulėlydis. Scout. 🌊🐾
...
## POST 9 — `9.jpg`
*Close-up Golden Retriever portrait "Bear"*  
**Pillar: Engagement / comment bait**

### Caption
Toks veidas. Toks vardas. Toks antakalis. 🐻🌿
...
## STORY — `Instagram story - 1.jpg`
*Brand collage: logo + Bear portrait + collar flat lay + Rocky + Daisy*  
